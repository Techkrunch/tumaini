...
if (isset($_POST['apply'])) {
	...
	$query = "INSERT INTO requests(allnames,nationalid,service,status, email,residence, phone) 
	VALUES ('$fname','$idnum', '$service', 'pending','$email','$residence','$phone')";
								...
								<form method="post" action="#" autocomplete="on">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<span class="input-group-addon">Choose Available Organs</span>
												<select class="form-control" name="serve">
													...
													// mysql select query
													$query = "SELECT * FROM `donors` where status ='pending'";
